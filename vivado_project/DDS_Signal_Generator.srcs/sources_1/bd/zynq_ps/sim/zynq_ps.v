...
(* CORE_GENERATION_INFO = "zynq_ps,IP_Integrator,{x_ipVendor=xilinx.com,x_ipLibrary=BlockDiagram,x_ipName=zynq_ps,x_ipVersion=1.00.a,x_ipLanguage=VERILOG,numBlks=1,numReposBlks=1,numNonXlnxBlks=0,numHierBlks=0,maxHierDepth=0,numSysgenBlks=0,numHlsBlks=0,numHdlrefBlks=0,numPkgbdBlks=0,bdsource=USER,da_ps7_cnt=1,synth_mode=OOC_per_IP}" *) (* HW_HANDOFF = "zynq_ps.hwdef" *) 
module zynq_ps
   (DDR_addr,
    DDR_ba,
    DDR_cas_n,
  ...
  (* X_INTERFACE_INFO = "xilinx.com:signal:clock:1.0 CLK.FCLK_CLK0_0 CLK" *) (* X_INTERFACE_PARAMETER = "XIL_INTERFACENAME CLK.FCLK_CLK0_0, CLK_DOMAIN zynq_ps_ps7_0_FCLK_CLK0, FREQ_HZ 50000000, INSERT_VIP 0, PHASE 0.000" *) output FCLK_CLK0_0;
  ...
  assign FCLK_CLK0_0 = ps7_FCLK_CLK0;
  assign FCLK_RESET0_N_0 = ps7_FCLK_RESET0_N;
  zynq_ps_ps7_0 ps7
