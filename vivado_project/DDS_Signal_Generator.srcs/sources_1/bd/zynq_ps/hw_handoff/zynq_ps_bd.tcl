...
proc create_root_design { parentCell } {
  ...
  connect_bd_net -net ps7_FCLK_CLK0 [get_bd_ports FCLK_CLK0_0] [get_bd_pins ps7/FCLK_CLK0] [get_bd_pins ps7/M_AXI_GP0_ACLK]
  connect_bd_net -net ps7_FCLK_RESET0_N [get_bd_ports FCLK_RESET0_N_0] [get_bd_pins ps7/FCLK_RESET0_N]
