// DDS_Signal_Generator_ILA.v
// Pure PL version with ILA for debugging
// Monitors: dds_out, fcw_sel, fcw_uart
...
// 8. ILA Debug Core
// Monitors: dds_out[7:0], fcw_sel[31:0], fcw_uart[31:0]
ila_0 your_instance_name (
    .clk(clk_100mhz),
    .probe0(dds_out),      // 8-bit
    .probe1(fcw_sel),      // 32-bit
    .probe2(fcw_uart)      // 32-bit
);
